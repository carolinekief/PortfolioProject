...
I have chosen to create a Shopping Cart component. This design is the one I could most wrap my head around in terms of how I would implement the methods and what methods I would want to create. I wanted to eliminate randomization (mainly because I am not good at it), and I felt using mapping to create a shopping cart with prices, tax, etc, would be something I could reasonably accomplish.
